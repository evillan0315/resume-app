...
interface CoverLetterDisplaySectionProps {
  title: string;
  content: string;
}

const CoverLetterDisplaySection: React.FC<CoverLetterDisplaySectionProps> = ({ title, content }) => {
...
export default CoverLetterDisplaySection;
